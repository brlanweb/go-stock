...
.indicator-entry { display:flex; width:100%; justify-content:space-between; padding:6px 7px; border:1px solid #3c475c; border-radius:0; background:#263247; color:#e7ecf4; font-size:11px; text-align:left; }
